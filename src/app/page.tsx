      ...
      <Card className="w-full max-w-lg shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Instantly calculate your fleet's fuel expenses.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="consumption" className="text-sm font-medium">Fuel Consumption (km/l)</Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10"
                  min="0"
                  aria-label="Fuel consumption in kilometers per liter"
                />
              </div>
            </div>
            <div className="space-y-2">
              <Label htmlFor="price" className="text-sm font-medium">Fuel Price (per liter)</Label>
              <div className="relative">
            ...
            <Card className="bg-muted/50">
              <CardContent className="p-6">
                <div className="flex flex-col items-center justify-center space-y-2 text-center">
                  <p className="text-lg font-medium text-muted-foreground">Total Fuel Cost</p>
